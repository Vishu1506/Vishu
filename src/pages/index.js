...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section padding="140px 0" sm-padding="40px 0" background="url(https://uploads.quarkly.io/5ff58b87d97277001a0876df/images/IMG20200823151408.jpg?v=2021-01-06T10:22:51.289Z) center/cover">
			<Override slot="SectionContent" position="relative" top="2px" bottom="2px" />
			<Box max-width="240px" padding="50px 80px 80px 50px" background="--color-light" color="--dark">
				...
				<Text font="--base">
					Hey my name is Viswantah i am here to just create a Demo website. To see what i can i do with this tool i appericiate the effort they are making.{"\n\t\t "}
				</Text>
			</Box>
		</Section>
		<Section
			...
			<Stack>
				<StackItem width="75%" lg-width="100%">
					...
					<Text as="h1" font="--headline1" md-font="--headline2" margin="10px 0">
						Just here to create a Demo Website Design . Like something from the near future here in India.
					</Text>
				</StackItem>
			</Stack>
				...
				<StackItem width="50%" md-width="100%">
					...
					>
						...
						<Text as="p" margin="6px 0" font="--headline3">
							Manikondo plot number 365, Sriramnagar Colony, Hyderabad, Telengana, India.
						</Text>
					</Box>
					<Box
						padding="0 0 0 64px"
